 ...
 *
 * Stacked layout manager places views stacking them onto each other. If the [view](AView) is expanding, then it
 * uses all space available. Otherwise, the [view](AView) is centered.
 *

...
AString AInput::getName(Key k)
{
    switch (k)
    {
        ...
        case AInput::NUMPAD_0: return "Numpad0";
        case AInput::NUMPAD_1: return "Numpad1";
        case AInput::NUMPAD_2: return "Numpad2";
        case AInput::NUMPAD_3: return "Numpad3";
        case AInput::NUMPAD_4: return "Numpad4";
        case AInput::NUMPAD_5: return "Numpad5";
        case AInput::NUMPAD_6: return "Numpad6";
        case AInput::NUMPAD_7: return "Numpad7";
        case AInput::NUMPAD_8: return "Numpad8";
        case AInput::NUMPAD_9: return "Numpad9";

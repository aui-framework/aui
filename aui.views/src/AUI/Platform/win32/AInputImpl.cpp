...
AInput::Key AInput::fromNative(int key) {
	...
	case VK_NUMPAD0:    vkey = AInput::NUMPAD_0;    break;
	case VK_NUMPAD1:    vkey = AInput::NUMPAD_1;    break;
	case VK_NUMPAD2:    vkey = AInput::NUMPAD_2;    break;
	case VK_NUMPAD3:    vkey = AInput::NUMPAD_3;    break;
	case VK_NUMPAD4:    vkey = AInput::NUMPAD_4;    break;
	case VK_NUMPAD5:    vkey = AInput::NUMPAD_5;    break;
	case VK_NUMPAD6:    vkey = AInput::NUMPAD_6;    break;
	case VK_NUMPAD7:    vkey = AInput::NUMPAD_7;    break;
	case VK_NUMPAD8:    vkey = AInput::NUMPAD_8;    break;
	case VK_NUMPAD9:    vkey = AInput::NUMPAD_9;    break;
...
int AInput::toNative(Key key) {
	...
	case AInput::NUMPAD_0: vkey = VK_NUMPAD0;    break;
	case AInput::NUMPAD_1: vkey = VK_NUMPAD1;    break;
	case AInput::NUMPAD_2: vkey = VK_NUMPAD2;    break;
	case AInput::NUMPAD_3: vkey = VK_NUMPAD3;    break;
	case AInput::NUMPAD_4: vkey = VK_NUMPAD4;    break;
	case AInput::NUMPAD_5: vkey = VK_NUMPAD5;    break;
	case AInput::NUMPAD_6: vkey = VK_NUMPAD6;    break;
	case AInput::NUMPAD_7: vkey = VK_NUMPAD7;    break;
	case AInput::NUMPAD_8: vkey = VK_NUMPAD8;    break;
	case AInput::NUMPAD_9: vkey = VK_NUMPAD9;    break;

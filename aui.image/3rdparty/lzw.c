...
struct lzw_read_ctx {
    ...
    data; /**< Pointer to start of input data */
...
struct lzw_ctx {
    ...
    colour_map; /**< Index to colour mapping. */
...
lzw__write_fn(struct lzw_ctx *ctx,
              void *restrict output_data,
              uint32_t output_length,
              ...
              uint16_t left) {
    uint8_t * restrict
    output_pos = (uint8_t *) output_data + output_used;
...
lzw__map_write_fn(struct lzw_ctx *ctx,
                  void *restrict output_data,
                  uint32_t output_length,
                  uint32_t output_used,
                  uint16_t code,

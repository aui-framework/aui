...
TEST_F(UIAssSizingModel, AllBoxesAreIdential) {
    ...
    static auto testView = [] {
        return Centered {
            Label { "all boxes should be equal" } AUI_OVERRIDE_STYLE {
    ...
    mTestWindow->setContents(Vertical {
      Centered {
        testView() AUI_OVERRIDE_STYLE { Padding { 10_dp }, Border { 1_px, AColor::BLACK }, FixedSize { 200_dp, {} } },
      },
      Centered {
        testView() AUI_OVERRIDE_STYLE { Padding { 10_dp }, Border { 1_px, AColor::BLACK }, MinSize { 200_dp, {} } },
      },
      Centered {
        testView() AUI_OVERRIDE_STYLE { Padding { 10_dp }, Border { 1_px, AColor::BLACK }, MaxSize { 200_dp, {} }, Expanding {} },
      },
    });
    // AUI_DOCS_CODE_END

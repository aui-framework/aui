 ...
 *
 * AFuture is returned by @ref AUI_THREADPOOL keyword:
 *
 * @code{cpp}
 ...
 *    threadpool thread (including the one that runs @ref AUI_THREADPOOL 's body). If value is not currently available, these

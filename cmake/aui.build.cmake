...
function(_aui_dll_copy_runtime_dependencies AUI_MODULE_NAME)
    ...
    set(_dst_dir_with_config ${_dst_dir})
    get_property(_is_multi_config GLOBAL PROPERTY GENERATOR_IS_MULTI_CONFIG)
    if (_is_multi_config)
        set(_dst_dir_with_config "${_dst_dir}/${CMAKE_BUILD_TYPE}")
    endif()
    ...
    foreach(_dependency ${ARGN})
        ...
        foreach(_include_dir ${_include_dirs})
            ...
            foreach(_runtime ${_runtimes})
                ...
                set(_dst_file "${_dst_dir_with_config}/${_name}")
                ...
                file(COPY ${_runtime} DESTINATION ${_dst_dir_with_config})
            endforeach()
        endforeach()
    endforeach()
endfunction()

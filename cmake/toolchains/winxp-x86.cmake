...
set(CMAKE_GENERATOR_TOOLSET     "v143" CACHE STRING "CMAKE_GENERATOR_TOOLSET"       FORCE)
set(CMAKE_VS_PLATFORM_TOOLSET   "v143" CACHE STRING "CMAKE_VS_PLATFORM_TOOLSET"     FORCE)
set(CMAKE_VS_WINDOWS_TARGET_PLATFORM_VERSION    "10.0.26100.0" CACHE STRING "SDK"   FORCE)


# if((DEFINED BUILD_SHARED_LIBS AND BUILD_SHARED_LIBS) OR NOT(DEFINED BUILD_SHARED_LIBS))
#     if (CMAKE_SIZEOF_VOID_P EQUAL 4)
#         set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /SUBSYSTEM:CONSOLE,5.01 /SUBSYSTEM:WINDOWS,5.01 /ENTRY:\"DllMainCRTStartupForYY_Thunks\"" CACHE STRING "" FORCE)
#     else()
#         set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /SUBSYSTEM:CONSOLE,5.02 /SUBSYSTEM:WINDOWS,5.02 /ENTRY:\"DllMainCRTStartupForYY_Thunks\"" CACHE STRING "" FORCE)
#     endif()
# else()
#     if (CMAKE_SIZEOF_VOID_P EQUAL 4)
#         set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /SUBSYSTEM:CONSOLE,5.01 /SUBSYSTEM:WINDOWS,5.01" CACHE STRING "" FORCE)
#     else()
#         set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} /SUBSYSTEM:CONSOLE,5.02 /SUBSYSTEM:WINDOWS,5.02" CACHE STRING "" FORCE)
#     endif()
# endif()
...
if (CMAKE_SIZEOF_VOID_P EQUAL 4)
    # set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} /SUBSYSTEM:CONSOLE,5.01 /SUBSYSTEM:WINDOWS,5.01 /ENTRY:\"DllMainCRTStartupForYY_Thunks\"" CACHE STRING "" FORCE)

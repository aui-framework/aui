...
DIR = re.compile(r".*(aui\.[^/\\]+)[/\\]tests(?:[/\\]|$)", re.IGNORECASE)
...
AUI_DOCS_OUTPUT = re.compile(r"^\s*//\s*AUI_DOCS_OUTPUT:\s*(.+)$", re.MULTILINE)
...
assert LOCATION_FILE.match(
    '    <location file="aui.core/src/AUI/Common/AProperty.h" line="145" column="1" bodyfile="aui.core/src/AUI/Common/AProperty.h" bodystart="145" bodyend="279"/>'
)
